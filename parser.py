...
class Parser():
    ...
    def parse_clothes(self):
        ...
        for filename in ["boyClothes.xml", "girlClothes.xml"]:
            if filename == "boyClothes.xml":
                ...
                gender = "girl"
            doc = etree.parse("config_all_tr/inventory/"+filename,
                              parser=self.parser)
            root = doc.getroot()
    ...
    def parse_cloth_sets(self):
        doc = etree.parse("config_all_tr/inventory/extend/clothesSets.xml",
                          parser=self.parser)
        root = doc.getroot()
        sets = {"boy": {}, "girl": {}}
    ...
    def parse_furniture(self):
        ...
        for filename in ["furniture.xml", "kitchen.xml", "bathroom.xml",
            ...
            doc = etree.parse(f"config_all_tr/inventory/{filename}",
                              parser=self.parser)
            root = doc.getroot()
    ...
    def parse_conflicts(self):
        doc = etree.parse("config_all_tr/inventory/extend/clothesRules.xml",
                          parser=self.parser)
        root = doc.getroot()
        conflicts = []
    ...
    def parse_privileges(self):
        doc = etree.parse("config_all_tr/modules/acl.xml", parser=self.parser)
        root = doc.getroot()
        privileges = {}
    ...
    def parse_game_items(self):
        doc = etree.parse("config_all_tr/inventory/game.xml",
                          parser=self.parser)
        root = doc.getroot()
        items = {}
    ...
    def parse_achievements(self):
        doc = etree.parse("config_all_tr/modules/achievements.xml",
                          parser=self.parser)
        root = doc.getroot()
        ac = []
    ...
    def parse_trophies(self):
        doc = etree.parse("config_all_tr/modules/trophies.xml",
                          parser=self.parser)
        root = doc.getroot()
        tr = []
    ...
    def parse_craft(self):
        doc = etree.parse("config_all_tr/modules/craft.xml",
                          parser=self.parser)
        root = doc.getroot()
        items = {}
    ...
    def parse_appearance(self):
        doc = etree.parse("config_all_tr/avatarAppearance/appearance.xml",
                          parser=self.parser)
        root = doc.getroot()
        apprnc = {"boy": {}, "girl": {}}
    ...
    def parse_relations(self):
        doc = etree.parse("config_all_tr/modules/relations.xml",
                          parser=self.parser)
        root = doc.getroot()
        statuses = {}
